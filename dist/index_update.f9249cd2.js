...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/index_update.js":[function(require,module,exports) {
//Query Selectors
...
var audioHit = new Audio("https://lynmarief.github.io/js-dev-final-capstone-starter-whack-a-mole/assets/cat_meow.wav");
var song = new Audio("https://lynmarief.github.io/js-dev-final-capstone-starter-whack-a-mole/assets/catsong.wav");
var time = 10;
var timer;
var lastHole = 0;
var points = 0;
...
/**
 * Play Audio Object during GamePlay
 *
 * The function takes in an audio Object
 * and calls to play this object. 
 *
 */
 ...
 * Loops Audio Object
 *
 * The function takes in an audio object and  
 * sets loop to true and then calls to play the audio. 
 *
 */
 ...
 *
 * The function takes in an audio object and
 * calls to pause the audio object.
 *
 */
...
function setDelay(difficulty) {
  // Set the correct return value based on difficulty
  if (difficulty == 'easy') {
    return 1500;
...
function chooseHole(holes) {
  // Choose Hole to return 
  var randomNum = randomInteger(0, 8);
  var hole = holes[randomNum];
  if (hole === lastHole) {
...
*/
function gameOver() {
  // Determine if game is over and return correct timeout or stop game. 
  if (time > 0) {
...
*/
function showUp() {
  var delay = setDelay(difficulty); // Use setDelay()
  var hole = chooseHole(holes); // Use chooseHole()
...
function updateTimer() {
  // If Time is not 0, decrement time and continue 
  if (time > 0) {
    time -= 1;
...
*/
function startTimer() {
  // Set Timer Interval and return to start timer
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/index_update.js"], null)
//# sourceMappingURL=/index_update.f9249cd2.js.map